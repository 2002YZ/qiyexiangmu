...
namespace Log
{
    ...
    //日志记录类
    public static class LogRecordRobot
    {
        ...
        public static void NewLogFile()
        {
            ...
            SystemLogFilePath = SystemLogPath + SystemTime + "SystemLogRobot.txt";
            if (File.Exists(SystemLogFilePath))
            {
                ...
                name = name.Replace(' ', '_');
                name = name.Replace(':', '_');
                SystemLogFilePath = SystemLogPath + name + "SystemLogRobot.txt";
